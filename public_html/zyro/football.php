		...
		<div class="vbox wb_container" id="wb_main">
			<div class="wb_cont_inner">
                <div>
                    ...
                    <span class="wb-stl-heading3 margin-left-lg"><a href="NFL<?php echo $qs; ?>" target="_self">Schedule</a></span>
                    <span class="wb-stl-heading3 margin-left-lg"><a href="NFLStandings<?php echo $qs; ?>" target="_self">Standings</a></span>
                </div>
                <div>
                    <?php echo $body_html; ?>
                    <p> </p>
