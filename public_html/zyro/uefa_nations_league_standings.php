<?php
    ...
    $tournament = Tournament::getSoccerTournamentStandingsMultiLeagueView($tournament_id, $simulation_mode);
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <span class="wb-stl-heading3 margin-left-lg"><a href="UEFANationsLeagueStandings<?php echo $qs; ?>" target="_self">Standings</a></span>
                            <span class="wb-stl-heading3 margin-left-lg"><a href="UEFANationsLeagueMatches<?php echo $qs; ?>" target="_self">Matches</a></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
