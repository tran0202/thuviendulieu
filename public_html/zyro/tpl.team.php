<?php
    class Team {
        ...
        function __construct($name, $group_name, $group_order, $parent_group_name, $parent_group_order, $flag_filename, $logo_filename = '') {
            $this -> name = $name;
...
//        function Team($name, $group_name, $group_order) {
//            $this -> name = $name;
//            $this -> group_name = $group_name;
//            $this -> group_order = $group_order;
//        }
